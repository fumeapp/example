        ...
        <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
          ...
          <div class="mt-5 flex-1 h-0 overflow-y-auto">
            <nav class="px-2">
              ...
              <div class="mt-8">
                <h3 id="teams-headline" class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                  Teams
                </h3>
      ...
      <div class="flex flex-col w-64 border-r border-gray-200 pt-5 pb-4 bg-gray-100">
        ...
        <div class="h-0 flex-1 flex flex-col overflow-y-auto">
          ...
          <div class="px-3 mt-6 relative inline-block text-left">
              ...
              >
                <span class="flex w-full justify-between items-center">
                  <span class="flex min-w-0 items-center justify-between space-x-3">
                    <img class="w-10 h-10 bg-gray-300 rounded-full flex-shrink-0" src="/jessy.jpeg" alt="">
            ...
            -->
            <div v-if="dropA" class="z-10 mx-3 origin-top absolute right-0 left-0 mt-1 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
              <div class="py-1">
          ...
          <div class="px-3 mt-5">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
              ...
              <input id="search" type="text" name="search" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-9 py-2 pr-3 border sm:text-sm border-gray-300 rounded-md" placeholder="Search">
            </div>
          </div>
          <!-- Navigation -->
          <nav class="px-3 mt-6">
        ...
        <div class="flex-1 flex justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex items-center">
            ...
            <div class="ml-3 relative">
              <div>
                <button id="user-menu" class="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500" aria-haspopup="true">
      ...
      <main class="flex-1 relative z-0 overflow-y-auto focus:outline-none" tabindex="0">
        ...
        <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
          ...
          <div class="mt-4 flex sm:mt-0 sm:ml-4">
            <button type="button" class="order-1 ml-3 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:order-0 sm:ml-0 assets-test">
              Share
            </button>
        ...
        <div class="px-4 mt-6 sm:px-6 lg:px-8">
          ...
          <ul class="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 xl:grid-cols-4 mt-3">
            <li v-for="i in 4" class="relative col-span-1 flex shadow-sm rounded-md">
              ...
              <div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
                ...
                <div class="flex-shrink-0 pr-2">
                  <button @click="dropB = !dropB" id="pinned-project-options-menu-0" aria-haspopup="true" class="w-8 h-8 bg-white inline-flex items-center justify-center text-gray-400 rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                  ...
                  <!--
                    ...
                    Leaving: "transition ease-in duration-75"
                      ...
                      To: "transform opacity-0 scale-95"
                  -->
                  <div v-if="dropB" class="z-10 mx-3 origin-top-right absolute right-10 top-3 w-48 mt-1 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200" role="menu" aria-orientation="vertical" aria-labelledby="pinned-project-options-menu-0">
                    <div class="py-1" role="none">
                ...
                <tr v-for="i in 10">
                  ...
                  <td class="pr-6">
                    <div class="relative flex justify-end items-center">
                      <button @clickl="dropC = !dropC" id="project-options-menu-0" aria-haspopup="true" type="button" class="w-8 h-8 bg-white inline-flex items-center justify-center text-gray-400 rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                        <span class="sr-only">Open options</span>
                        <!-- Heroicon name: dots-vertical -->
                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                          <path d="M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z" />
                      ...
                      Leaving: "transition ease-in duration-75"
                        ...
                        To: "transform opacity-0 scale-95"
                    -->
                      <div v-if="dropC" class="mx-3 origin-top-right absolute right-7 top-0 w-48 mt-1 rounded-md shadow-lg z-10 bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200" role="menu" aria-orientation="vertical" aria-labelledby="project-options-menu-0">
                        <div class="py-1" role="none">
